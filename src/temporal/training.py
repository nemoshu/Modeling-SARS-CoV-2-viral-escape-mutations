...
def main():
    if subtype_flag == 0:
        ...
        # data_set = 'D:/TBSI/Masters_Thesis/NLP_papers/TEMPO/Tempo-main/data/processed/H1N1/triplet_cluster'
        data_path = 'D:/TBSI/Masters_Thesis/NLP_papers/TEMPO/Tempo-main/data/raw/H1N1_cluster/'
        data_set = 'D:/TBSI/Masters_Thesis/NLP_papers/TEMPO/Tempo-main/data/processed/H1N1_drop_duplicates/triplet_cluster'
    elif subtype_flag == 1:
        data_path = 'D:/TBSI/Masters_Thesis/NLP_papers/TEMPO/Tempo-main/data/raw/H3N2_cluster/'
        data_set = 'D:/TBSI/Masters_Thesis/NLP_papers/TEMPO/Tempo-main/data/processed/H3N2/triplet_cluster'

    elif subtype_flag == 2:
        data_path = 'D:/TBSI/Masters_Thesis/NLP_papers/TEMPO/Tempo-main/data/raw/H5N1_cluster/'
        data_set = 'D:/TBSI/Masters_Thesis/NLP_papers/TEMPO/Tempo-main/data/processed/H5N1/triplet_cluster'

    elif subtype_flag == 3:
        data_path = 'D:/TBSI/Masters_Thesis/NLP_papers/TEMPO/Tempo-main/data/processed/COV19/'
        data_set = 'D:/TBSI/Masters_Thesis/NLP_papers/TEMPO/Tempo-main/data/processed/COV19/triplet_cluster'
        # data_path = 'D:/TBSI/Masters_Thesis/NLP_papers/TEMPO/Tempo-main/data/processed/COV19/'
        # data_set = 'D:/TBSI/Masters_Thesis/NLP_papers/TEMPO/Tempo-main/data/processed/COV19/triplet_cluster'
